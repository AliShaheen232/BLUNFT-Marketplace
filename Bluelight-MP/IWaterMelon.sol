...
interface IWaterMelon{
    ...
    function listNFTForFixedType(address nftContractAddress, uint256 tokenId, string memory iPFS, uint256 price) external;
    function listNFTForAuctionType(address nftContractAddress, uint256 tokenId, string memory iPFS, uint256 price, uint256 maxPrice, uint256 auctionEndTime) external;
